...
sendMessages :: (IsString a, Show a) => OutBound a -> [a] -> String -> String -> Int -> IO ()
...
sendQueueStatuses {- cid -} !hostName !queueName !messagePeriodMicroSeconds =
    sendMessages {- cid -} toStringBytesConverter ([]::[String]) {-queueStatuses-} hostName queueName messagePeriodMicroSeconds
...
sendContactSegments {- cid -} !hostName !queueName !messagePeriodMicroSeconds = 
    sendMessages {- cid -} toStringBytesConverter ([]::[String]) {-contactSegments-} hostName queueName messagePeriodMicroSeconds
